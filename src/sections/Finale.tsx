...
export function Finale() {
  ...
  useEffect(() => {
    ...
    const load = () => {
      ...
      scrub = new FrameScrub(canvas.current!, { path: set.path, count: set.count, focusX: set.focusX, crossfade: orient === "desktop", focusWidth: set.focusWidth, version: site.video.frames.version, use: Math.round(OUTRO_SECONDS * site.video.frames.fps), smoothing: 0.16, onState });
